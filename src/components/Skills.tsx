  ...
  return (
    <section id='skills' className='py-16 md:py-20 relative z-10'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        rounded-full text-neo-secondary font-medium mb-4'>TECHNICAL EXPERTISE</span>
        <h2 className='text-3xl sm:text-4xl md:text-5xl font-bold mb-6'>
          <span className='gradient-text'>My Skills</span>
        </h2>
        <p className='text-lg sm:text-xl max-w-3xl mx-auto'>
          A blend of design sensibility and technical prowess to create exceptional digital products
        </p>
      </motion.div>
      ...
      >
        {skills.map((skill) => (
          ...
          >
            ...
            >
              <skill.icon 
              className='w-8 h-8 text-neo-primary'
              />
            </motion.div>
